...
declare const Transfer: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "defaultValue" | "data" | "title" | "modelValue" | "simple" | "selected" | "showSearch" | "showSelectAll" | "defaultSelected" | "oneWay">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "change", value: string[]) => void) & ((event: "select", selected: string[]) => void) & ((event: "update:modelValue", value: string[]) => void) & ((event: "search", value: string, type: "source" | "target") => void) & ((event: "update:selected", selected: string[]) => void);
        $el: any;
