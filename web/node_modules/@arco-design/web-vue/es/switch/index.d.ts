...
declare const Switch: {
    new (...args: any[]): {
        ...
        $emit: ((event: "change", value: string | number | boolean, ev: Event) => void) & ((event: "blur", ev: FocusEvent) => void) & ((event: "focus", ev: FocusEvent) => void) & ((event: "update:modelValue", value: string | number | boolean) => void);
        $el: any;
