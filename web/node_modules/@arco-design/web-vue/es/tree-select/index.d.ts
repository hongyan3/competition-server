...
declare const TreeSelect: {
    new (...args: any[]): {
        ...
        } & import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, "disabled" | "error" | "allowClear" | "popupVisible" | "defaultPopupVisible" | "scrollbar" | "border" | "multiple" | "data" | "loading" | "allowSearch" | "defaultInputValue" | "fallbackOption" | "showHeaderOnEmpty" | "showFooterOnEmpty" | "selectable" | "labelInValue" | "treeCheckable" | "treeCheckStrictly" | "treeCheckedStrategy" | "disableFilter">;
        $attrs: {
            [x: string]: unknown;
        };
        $refs: {
        ...
        $emit: ((event: "clear") => void) & ((event: "change", value: string | number | (string | number)[] | import("./interface").LabelValue | import("./interface").LabelValue[] | undefined) => void) & ((event: "update:popupVisible", visible: boolean) => void) & ((event: "update:modelValue", value: string | number | (string | number)[] | import("./interface").LabelValue | import("./interface").LabelValue[] | undefined) => void) & ((event: "update:inputValue", inputValue: string) => void) & ((event: "inputValueChange", inputValue: string) => void) & ((event: "search", searchKey: string) => void) & ((event: "popup-visible-change", visible: boolean) => void);
        $el: any;
