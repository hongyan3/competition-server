...
declare const VerificationCode: {
    new (...args: any[]): {
        ...
        $emit: ((event: "change", value: string) => void) & ((event: "input", inputValue: string, index: number, ev: Event) => void) & ((event: "update:modelValue", value: string) => void) & ((event: "finish", value: string) => void);
        $el: any;
