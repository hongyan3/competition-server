        ...
        <div class="inner-conatinter">
            <a-form :model="userForm" :style="{ width: '400px' }" @submit="handleSubmit">
                ...
                <a-form-item field="userAvatar" label="头像">
                    <a-upload list-type="picture-card" :data="{ business: 'user_avatar' }"
                        :action="`${OpenAPI.BASE}/api/file/upload`" :with-credentials="true"
                        :file-list="fileList.list" :limit="1" @success="uploadSuccessHandle" image-preview />
                </a-form-item>
                <a-form-item>
