  ...
  <div class="enrty-list-conatiner">
    ...
    <a-table :columns="columns" :data="data.entryList" :pagination="{
      ...
      <template #optional="{ record }">
        ...
        <a-button style="margin-left: 5px;" type="primary" @click="">修改</a-button>
...
import {EntryControllerService as entryService, type EntryVO, UserControllerService as userService,} from '@/api'
